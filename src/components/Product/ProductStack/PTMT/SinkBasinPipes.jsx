      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-100">
        <div className="bg-gray-100 rounded-lg shadow-lg overflow-hidden max-w-6xl w-full p-8">
          ...
          <div className="flex flex-col md:flex-row items-center mt-6">
            <div className="w-full md:w-1/2 lg:w-[500px] lg:h-[300px] h-auto object-cover rounded mb-6 md:mb-0">
              <img 
                src={product.image} 
                ...
                <table className="min-w-full bg-white border border-gray-300">
                  ...
                  <tbody>
                    <tr className="even:bg-orange-200">
                      <td className="py-3 px-5 text-gray-700 text-center text-lg border-r border-gray-300">
                        {product.sizeWeight.filter(item => !item.withCup).map(item => `${item.s}   ${  item.w}`).join('  , ')}
                      </td>
                      <td className="py-3 px-5 text-gray-700 text-center text-lg">
