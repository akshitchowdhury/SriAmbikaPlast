              ...
              <table className="min-w-full bg-white border border-gray-300">
                  ...
                  <tbody>
                    ...
                    <td className="py-3 px-5 text-gray-700 text-center font-semibold text-lg border-r border-gray-300">
                        ...
                        {product.sizeWeight.filter(item => !item.withCup).map(item => `32"-30"`).join(', ')}
                      </td>
                      <td className="py-3 px-5 text-gray-700 text-center font-semibold text-lg border-r border-gray-300">
                        
                        {product.sizeWeight.filter(item => item.withCup).map(item => `38`).join(', ')}
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <table className="min-w-full bg-white border border-gray-300">
                  ...
                  <tbody>
                    ...
                    <td className="py-3 px-5 text-gray-700 text-center font-semibold text-lg border-r border-gray-300">
                        ...
                        {product.sizeWeight.filter(item => !item.withCup).map(item => `42"-40"`).join(', ')}
                      </td>
                      <td className="py-3 px-5 text-gray-700 text-center font-semibold text-lg border-r border-gray-300">
                        
                        {product.sizeWeight.filter(item => item.withCup).map(item => `48`).join(', ')}
                      </td>
                    </tr>
                  </tbody>
                </table>
