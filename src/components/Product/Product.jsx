...
const ProductCard = ({ productName, image }) => {
  ...
  return (
    <div className="relative bg-white shadow-lg border border-gray-200 rounded-none 
    overflow-hidden m-4 p-4 w-[260px] lg:w-full 
      ...
      <div className="container mx-auto px-4 py-8" data-aos="fade-up">
        {filteredProducts.map((categoryData, index) => (
          <div key={index} className="mb-12" data-aos="fade-up">
            ...
            <div className={`grid grid-cols-1 mx-[15px]  md:grid-cols-3 lg:grid-cols-${categoryData.subproducts.length < 3 ? '2' : '3'} gap-6`}>
