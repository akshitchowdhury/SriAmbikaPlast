    ...
    <div ref={ref} className="ContactForm flex-1 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-4 md:p-8 rounded-lg shadow-lg">
      ...
      <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          <button
            type="submit"
            className="w-full md:w-[200px] py-2 md:py-3 px-4 bg-orange-600 text-white font-medium rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 ease-in-out"
          >
            Contact Us
          </button>
        </div>
